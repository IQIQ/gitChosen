//
//  Report_PoleViewController.swift
//  BigProject
//
...
import Foundation
class Report_PoleViewController: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    var dataIDPole = ["All"] + StructOperation.atas.data_Pole_ID
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        print("ViewDidLoad Main")
        ReportPole_TableViewController().viewWillAppear(true)
    ...
    @IBAction func SelectFrom(_ sender: UITextField) {
        ...
        datePickerView.addTarget(self, action: #selector(Report_PoleViewController.datePickerValueChangedTextFrom(sender:)), for: UIControlEvents.valueChanged)
        ...
        let doneButton = UIBarButtonItem(title: "Done", style: .plain, target: self, action: #selector(Report_PoleViewController.donePickerFrom))
    ...
    @IBAction func SelectTo(_ sender: UITextField) {
        ...
        datePickerView.addTarget(self, action: #selector(Report_PoleViewController.datePickerValueChangedTextTo(sender:)), for: UIControlEvents.valueChanged)
        ...
        let doneButton = UIBarButtonItem(title: "Done", style: .plain, target: self, action: #selector(Report_PoleViewController.donePickerTo))
    ...
    @IBAction func SelectCard(_ sender: UITextField) {
        ...
        let doneButton = UIBarButtonItem(title: "Done", style: .plain, target: self, action: #selector(Report_PoleViewController.donePickerCard))
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return dataIDPole.count
    }
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return dataIDPole[row]
    }
    
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int){
        TextCard.text = dataIDPole[row]
    }
    ...
    @IBAction func ClearButton(_ sender: UIButton) {
        self.TextCard.text = "----Select Pole----"
    ...
    @IBAction func SearchButton(_ sender: UIButton) {
        ...
        {
            parameters = ["user_id": StructOperation.atas.UserID,"types": "Pole","pole_or_card_id": "","fromdate": TextFrom.text!,"enddate": TextTo.text!]
        }
        ...
        else if (TextFrom.text! == "Start Date" && TextTo.text! == "End Date")
        {
            ...
            parameters = ["user_id": StructOperation.atas.UserID,"types": "Pole","pole_or_card_id": TextCard.text!,"fromdate": TextFrom.text!,"enddate": TextTo.text!]
        }
        
        if (TextCard.text != "----Select Pole----"){
    ...
    //--------------------------------------- Fix  API ----------------------------------
                ...
                //---------------------------------------- Fix API --------------------------------
                    ...
                    do {
                        ...
                        guard let teamJSON =  try JSONSerialization.jsonObject(with: data as Data, options: []) as? [String: Any],
                            let liquidLocations = teamJSON["Datagrid"] as? [[String:Any]]
                            else { return }
                        ...
                        for i in 0 ..< liquidLocations.count{
                            ...
                            let transaction_id = String(liquidLocations[i]["transaction_id"] as! NSInteger)
                            let card_id: String = ((liquidLocations[i]["card_id"] as! NSString) as String)
                            let pole_id: String = ((liquidLocations[i]["pole_id"] as! NSString) as String)
                            let meterstartdate: String = ((liquidLocations[i]["meterstartdate"] as! NSString) as String)
                            let metereinddate: String = ((liquidLocations[i]["metereinddate"] as! NSString) as String)
                            let price: String = ((liquidLocations[i]["price"] as! NSString) as String)
                            let total: String = ((liquidLocations[i]["Total"] as! NSString) as String)
                            let totalprice: String = ((liquidLocations[i]["totalprice"] as! NSString) as String)
            ...
            let alert = UIAlertController(title: "Alert", message: "Please Select PoleID", preferredStyle: UIAlertControllerStyle.alert)
    ...
    @IBAction func b_ReportCard(_ sender: Any) {
        resetData()
    }
